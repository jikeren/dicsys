...
Page({
  data: {
    ...
    items2: [
      {value: 'many-man', name: '多员工'},
      {value: 'singel-man', name: '单员工'},
      {value: 'many-device', name: '多焊机'},      
      {value: 'singel-device', name: '单焊机', checked: 'true'},
    ],
    listData:[
  ...
  barShow: function () {
    let bar = {
      canvasId: 'barGraph',
      type: 'column',
      categories: ['KX0000012', 'KX0000013', 'KX000014', 'KX0000015', 'KX000001'],
      series: [
      //   {
      //   name: '成交量1',
